...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10, classifier = True, use_norm=False):
        ...
        if self.classifier:
            if use_norm:
                self.linear = NormedLinear(64, num_classes)  # normlization classifier look more at
                                                             # Learning Imbalanced Datasets with Label-Distribution-Aware Margin Loss
            else:
                self.linear = nn.Linear(64, num_classes)  # linear classifier
...
def resnet32(num_classes=10, classifier=True, use_norm=False):
    return ResNet_s(BasicBlock, [5, 5, 5], classifier = classifier, num_classes=num_classes, use_norm=use_norm)
